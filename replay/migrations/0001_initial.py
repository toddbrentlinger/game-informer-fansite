    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnails', models.ManyToManyField(help_text='Enter thumbnail images for the video.', to='replay.Thumbnail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('heading', models.ForeignKey(help_text='Enter heading type.', on_delete=django.db.models.deletion.PROTECT, to='replay.heading')),
            ],
            options={
