    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_episode', models.OneToOneField(help_text='Enter show episode for the Replay episode.', on_delete=django.db.models.deletion.PROTECT, to='shows.showepisode')),
            ],
            options={
