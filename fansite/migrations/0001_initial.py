    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, help_text='Enter date started the position.', null=True)),
                ('position', models.ManyToManyField(help_text='Enter position of the staff member.', to='fansite.StaffPosition')),
