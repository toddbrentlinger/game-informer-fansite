...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('igdb_id', models.PositiveIntegerField(blank=True, help_text='Enter IGDB game ID to be used with API.', null=True, verbose_name='IGDB ID')),
                ('title', models.CharField(help_text='Enter game title.', max_length=100)),
                ('system', models.CharField(help_text='Enter game system (ex. PC, PS4, XBox 360, etc.).', max_length=30)),
                ('release_year', models.PositiveSmallIntegerField(help_text='Enter date the game was released.', verbose_name='Release Year')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('games', models.ManyToManyField(blank=True, help_text='Enter games played during the segment.', to='fansite.Game')),
                ('segment_type', models.ForeignKey(help_text='Enter type of segment.', on_delete=django.db.models.deletion.PROTECT, to='fansite.segmenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_segment', models.ForeignKey(blank=True, help_text='Enter middle segment for the Replay episode.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_middle_segment_related', to='fansite.segment', verbose_name='Middle Segment')),
                ('second_segment', models.ForeignKey(blank=True, help_text='Enter second segment for the Replay episode.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_second_segment_related', to='fansite.segment', verbose_name='Second Segment')),
                ('thumbnails', models.ManyToManyField(blank=True, help_text='Enter thumbnail images for the episode.', to='fansite.Thumbnail')),
                ('youtube_video', models.ForeignKey(blank=True, help_text='Enter the YouTube video for the episode.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='fansite.youtubevideo', verbose_name='youTube Video')),
            ],
            options={
